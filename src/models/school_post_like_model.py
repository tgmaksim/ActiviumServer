...
class SchoolPostLike(BaseModel):
    ...
    __custom_table_args__ = (
        PrimaryKeyConstraint('parent_id', 'post_id', name="school_post_likes_parent_id_post_id"),

        Index("school_post_likes_post_id_parent_id", 'post_id', 'parent_id'),
        ...
        ForeignKeyConstraint(
            ...
            onupdate="CASCADE",
            ondelete="CASCADE",
            name="school_post_likes_parent_id_fkey"
        ),
        ForeignKeyConstraint(
            ['post_id'],
            ...
            onupdate="CASCADE",
            ondelete="CASCADE",
            name="school_post_likes_post_id_fkey"
        )
    )
