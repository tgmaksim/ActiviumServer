...
class Session(BaseModel):
    ...
    parent_id: Mapped[Optional[int]] = mapped_column(
        BigInteger, ForeignKey("parents.parent_id", ondelete="CASCADE", onupdate="CASCADE"), nullable=True)
    active_child_id: Mapped[int] = mapped_column(
        BigInteger, ForeignKey("children.child_id", ondelete="RESTRICT", onupdate="CASCADE"), nullable=True)
