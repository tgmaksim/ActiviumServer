...
TITLE = f"API учебного приложения «{settings.PROJECT_NAME_RU}»"

SUMMARY = f"Полная документация серверной части учебного приложения «{settings.PROJECT_NAME_RU}»"
...
DESCRIPTION = (
    f"**Особенности API «{settings.PROJECT_NAME_RU}»**\n\n"
