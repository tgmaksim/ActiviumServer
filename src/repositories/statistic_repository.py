...
class StatName(Enum):
    ...
    registrationSchoolAdmin = "Регистрация администратора образовательной организации"
    authorization = "Повторная авторизация пользователя"
    authorizationSchoolAdmin = "Повторная авторизация администратора образовательной организации"
    ...
    createAdminStatistics = "Создание отчета со статистикой образовательной организации"
