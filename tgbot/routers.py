...
def get_tg_router() -> Router:
    ...
    from .handlers import start, reviews, app, help, admin, school, menu, school_admins, school_posts, school_statistics, school_bells, school_ea
    ...
    router.include_router(school_ea.router)
